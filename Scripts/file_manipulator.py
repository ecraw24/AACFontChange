...
def rezipDB(dbFilePath, zipFilePath, tmpdirpath):
    ...
    shutil.move(tmpdirpath + '\\temp.c4v', tmpdirpath + '\\tmpDir\\')
    os.rename(tmpdirpath + '\\tmpDir\\temp.c4v', os.path.splitext(c4vOriginalName[0])[0] + '-NEW.c4v')
